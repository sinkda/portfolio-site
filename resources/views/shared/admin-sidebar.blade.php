<nav class="absolute lg:relative lg:transform-none lg:opacity-100 z-10 w-64 h-screen text-white bg-gray-800 p-3 transform duration-200 ease-in-out"
    ...
    <div class="mt-8">
        ...
        <a href="{{ route('admin.projects.index') }}" class="flex items-center w-full p-4 hover:bg-indigo-800 rounded-md">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="{{ route('admin.messages.index') }}" class="flex items-center w-full p-4 hover:bg-indigo-800 rounded-md">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
